...
```mdx-code-block
import GitWindows from "./git_markdown/_git-windows.mdx"
import GitMacOS from "./git_markdown/_git-macos.mdx"
import GitLinux from "./git_markdown/_git-linux.mdx"
...
If this is your first time installing Git, you should setup your author details
by running the following command, replacing it with the correct details:
```
