...
:::info
Clicking on `View Preview` will allow you to view a temporary deployment of your app.

This is great for verifying that your pull request creates an
...
![Vercel Hosting Pull Request Deployment](./img/vercel-hosting-pull-request-deployment.png)
